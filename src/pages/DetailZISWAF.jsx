    ...
    <div>
      ...
      <div className="flex gap-5 mt-5 xl:mt-20 justify-between mx-4 xl:mx-20 ">
        <div className="font-Inter text-NEUTRAL04">
          <h1 className="my-2 lg:text-4xl md:text-4xl sm:text-2xl text-base xl:text-6xl md:w-4/6 font-bold">
          ...
          <Link
            ...
            className="my-2 lg:my-8 bg-primary rounded-md md:rounded-full px-4 py-2 text-sm md:text-xl text-white font-bold hover:scale-105"
          >
            Donasi Sekarang
          </Link>
        </div>
