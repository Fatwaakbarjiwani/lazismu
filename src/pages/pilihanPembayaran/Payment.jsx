...
import { statusPembayaran } from "../../redux/action/transactionAction";
...
export default function Payment() {
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText(`797706${noVa.vaNumber}`).then(() => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex justify-center items-center pt-5 font-Inter">
      <div className="sm:max-w-xl w-full bg-white shadow-lg p-4 sm:p-8 rounded-lg">
        ...
        <div className="font-Inter bg-orange-500 p-4 rounded text-white w-full flex flex-col items-center mb-4">
        ...
        <div className="space-y-2">
            ...
            <>
              <div className="border p-2 flex justify-between">
                ...
                <div className="w-3/6 font-Inter text-gray-600 space-y-2">
                  ...
                  ) : statusBilling.success == "true" && timerEnded == false ? (
            ...
            <>
              <div className="flex items-end gap-1 text-sm font-semibold text-primary">
                <div className="h-full w-6">
                  <RiBillFill color="orange" className="w-full h-full" />
                </div>
                <p className="text-orange">Rincian biaya</p>
              </div>
          ...
          {status == true && (
            <div className="flex items-end gap-1 text-sm font-semibold text-primary">
              ...
              <p className="text-orange text-lg">kategori Pembayaran</p>
            </div>
          )}
          {status == true &&
            id !== "zakat" &&
            ...
            <>
              {status === false && (
                <div className="flex flex-col items-center">
                  <div className="w-full sm:w-2/4 border rounded p-4 bg-white shadow-md">
                  ...
                  <div className="rounded-md font-mono text-lg">
                    <div>
                      ...
                      <p className="text-2xl font-black text-gray-600">
                        {id == "zakat" ? <>797727{noVa}</> : <>797706{noVa}</>}
                      </p>
                    </div>
                  </div>
                  <button
                    className="bg-orange-500 active:scale-105 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        ...
        {status === false && (
          <div className=" mt-5 sm:mt-10">
            <Link to={`/lazismu/detailDonasi/detailDonasi`}>
              <Button
                color="orange"
                className="w-full font-bold mt-2 bg-orange-400 text-white hover:bg-orange-500 active:bg-orange-500 active:scale-105"
              >
                Cek Donasi Lainnya
              </Button>
            </Link>
