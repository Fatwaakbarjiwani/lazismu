...
export default function VisiMisi() {
  return (
    <div className="font-Inter px-4 md:px-20 py-14">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Visi</h2>
        <p className="text-gray-700">Menjadi Lembaga Amil Zakat Terpercaya</p>
      </div>
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Misi</h2>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Prinsip</h2>
        <ol className="list-decimal list-inside text-gray-700 space-y-2 text-justify">
          ...
          <li>
            <span className="font-bold">Keadilan:</span> artinya mampu bertindak
            adil, yakni sikap memperlakukan secara setara di dalam memenuhi
            hak-hak yang timbul berdasarkan perjanjian serta peraturan
            perundangan yang berlaku;
          </li>
          <li>
            <span className="font-bold">Kepastian hukum:</span> artinya muzaki
            dan mustahik harus memiliki jaminan dan kepastian hukum dalam proses
            pengelolaan dana ZISKA;
          </li>
          <li>
          ...
          <li>
            <span className="font-bold">Sinergi:</span> artinya sikap membangun
            dan memastikan hubungan kerja sama internal yang produktif serta
            kemitraan yang harmonis dengan para pemangku kepentingan dana ZISKA
      ...
      <div>
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Tujuan</h2>
        <ol className="list-decimal list-inside text-gray-700 space-y-2 text-justify">
          <li>
