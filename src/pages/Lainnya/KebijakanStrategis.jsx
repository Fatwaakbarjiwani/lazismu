    ...
    <div className="font-Inter px-4 md:px-20 py-14">
      ...
      <div className="mb-8">
        ...
        <ol className="list-decimal list-inside text-gray-700 space-y-2 mb-8 text-justify">
          ...
          <li>
            Melakukan sinergi dengan institusi dan komunitas diluar Muhammadiyah
        ...
        <p className="text-gray-700 mb-6 text-justify">
          ...
          Muhammadiyah. Seperti program pendayagunaan bidang pertanian, lazismu
          bersinergi dengan MPM (Majelis Pemberdayaan Masyarakat) PP
          ...
          komunitas hobby dan profesi dan sebagainya. Tujuan dari sinergi adalah
          agar pendayagunaan memberi manfaat yang maksimal kepada masyarakat
          karena dikelola oleh lembaga pengelola yang expert serta menjangkau
