                ...
                <div className="flex items-center sm:gap-5 justify-between">
                  ...
                  {edit == true && (
                    <label htmlFor="dropzone-file">
                      <FaUserPen
                        color="orange"
                        className="hidden w-8 h-8 sm:absolute bg-orange-100 rounded-full p-1 top-[34vh] left-[42%] active:scale-105"
                      />
                      <input
                        id="dropzone-file"
                        type="file"
                    ...
                    {edit == true && (
                      <div className="flex w-full gap-2 items-center">
                        ...
                        <button
                          ...
                          className="w-1/6 bg-orange-400 rounded text-white active:scale-105 py-2"
                        >
                          Submit
                        </button>
                      </div>
            ...
            <div className="md:w-4/6">
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="flex bg-white shadow rounded-lg items-center p-2 gap-4">
                  <FaHands
                    color="white"
                    className="bg-orange-600 rounded-lg h-12 w-12 p-2"
                  />
                  <div>
                ...
                <div className="flex bg-white shadow rounded-lg items-center p-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold">
                      Rp {userSummary?.campaign_total || 0}
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex bg-white shadow rounded-lg items-center p-2 gap-4 mt-4">
                ...
                <div>
                  ...
                  <p className="font-bold">
                    Rp {userSummary?.total_donation || 0}
                  </p>
                </div>
              </div>
            </div>
