...
function Pilar() {
  return (
    <Timeline>
      <Timeline.Item>
        <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -start-4 ring-8 ring-white">
          <HiAcademicCap color="orange" className="" />
        </span>
      ...
      <Timeline.Item>
        <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -start-4 ring-8 ring-white ">
          <GiHealingShield color="orange" className="" />
        </span>
        <Timeline.Content className="pl-2">
      ...
      <Timeline.Item>
        <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -start-4 ring-8 ring-white ">
          <FaChartLine color="orange" className="" />
        </span>
        <Timeline.Content className="pl-2">
      ...
      <Timeline.Item>
        <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -start-4 ring-8 ring-white ">
          <FaGroupArrowsRotate color="orange" className="" />
        </span>
        <Timeline.Content className="pl-2">
      ...
      <Timeline.Item>
        <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -start-4 ring-8 ring-white ">
          <FaBookQuran color="orange" className="" />
        </span>
        <Timeline.Content className="pl-2">
      ...
      <Timeline.Item>
        <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -start-4 ring-8 ring-white ">
          <FaMountainCity color="orange" className="" />
        </span>
        <Timeline.Content className="pl-2">
