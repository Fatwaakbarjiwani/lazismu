      ...
      {user?.username ? (
        <div className="gap-1 p-1 md:gap-3 xl:gap-5">
          ...
          >
            ...
            <button className="font-Inter text-base md:text-lg lg:text-xl font-bold text-orange-400">
              {user.username}
            </button>
          </Link>
          <button
        ...
        <div className="flex flex-col items-center gap-2 p-2">
          <button
            ...
            className="flex gap-2 w-full justify-center border-2 border-orange-200  rounded items-center active:scale-105"
          >
            <img src={profile} className="w-3" alt="" />
            <p className="font-Inter text-orange-500 text-sm md:text-base lg:text-lg xl:text-xl font-bold">
              Masuk
            </p>
          </button>
          <button
            className="p-1 font-Inter bg-orange-500 px-4 w-full rounded font-bold text-sm md:text-base lg:text-lg xl:text-xl text-white active:scale-105"
