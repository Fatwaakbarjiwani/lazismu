...
function PilarH() {
  return (
    <div className="hidden md:block p-10 w-full bg-orange-100/20">
      <Timeline horizontal className="flex gap-4 justify-between">
          ...
          <Timeline.Content>
            <div className="flex justify-center">
              <span className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full">
                <HiAcademicCap color="orange" className="w-6 h-6" />
              </span>
            </div>
            <Timeline.Title className="text-center">Pendidikan</Timeline.Title>
            <Timeline.Body>
        ...
        <Timeline.Item>
          <Timeline.Content>
            <div className="flex justify-center">
              <span className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full -start-4e-900">
                <GiHealingShield color="orange" className="w-6 h-6" />
              </span>
            </div>
            <Timeline.Title className="text-center">Kesehatan</Timeline.Title>
            <Timeline.Body>
        ...
        <Timeline.Item>
          <Timeline.Content>
            <div className="flex justify-center">
              <span className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full -start-4e-900">
                <FaChartLine color="orange" className="w-6 h-6" />
              </span>
            </div>
      ...
      <Timeline horizontal className="flex gap-4">
        <Timeline.Item>
          <Timeline.Content>
            <div className="flex justify-center">
              <span className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full -start-4e-900">
                <FaBookQuran color="orange" className="w-6 h-6" />
              </span>
            </div>
        ...
        <Timeline.Item>
          <Timeline.Content>
            <div className="flex justify-center">
              <span className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full -start-4e-900">
                <FaGroupArrowsRotate color="orange" className="w-6 h-6" />
              </span>
            </div>
        ...
        <Timeline.Item>
          <Timeline.Content>
            <div className="flex justify-center">
              <span className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full -start-4e-900">
                <FaMountainCity color="orange" className="w-6 h-6" />
              </span>
            </div>
