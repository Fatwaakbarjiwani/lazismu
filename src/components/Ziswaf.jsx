    ...
    <div className="xl:w-2/6 w-full sm:w-4/6 lg:w-5/6 mx-4 top-[40vh] drop-shadow-3xl bg-white p-4 rounded-lg">
      <div className="bg-primary rouded-full w-full flex justify-between px-4 py- font-Inter rounded-lg">
        <button
          ...
          className={`text-white font-bold text-base md:text-lg focus:bg-orange-600 xl:rounde p-2 hover:bg-orange-600 w-2/6 ${
            button == "zakat" ? "bg-orange-600" : "bg-transparant"
          }`}
        >
          Zakat
        </button>
        <button
          ...
          className={`text-white font-bold text-base md:text-lg focus:bg-orange-600 xl:rounde p-2 hover:bg-orange-600 w-2/6 ${
            button == "infak" ? "bg-orange-600" : "bg-transparant"
          }`}
        >
          Infak
        </button>
        <button
          ...
          className={`text-white font-bold text-base md:text-lg focus:bg-orange-600 xl:rounde p-2 hover:bg-orange-600 w-2/6 ${
            button == "waqaf" ? "bg-orange-600" : "bg-transparant"
          }`}
        >
          Wakaf
        </button>
      ...
      <div className="font-Inter mt-3">
        ...
        <div className="flex md:justify-end">
          {click == false && (
            <button
              className="mt-2 md:text-white md:mt-0 p-2 md:p-1 w-full md:w-1/2 sm:p-3 text-sm sm:text-lg bg-white md:bg-primary rounded-md ring-1 outline-none ring-orange-500 drop-shadow-lg"
              onClick={handleClick}
            >
              Kategory {button}
            </button>
