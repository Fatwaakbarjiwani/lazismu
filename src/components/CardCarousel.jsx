      ...
      >
        ...
        <div className="text-[8px] px-1">
          ...
          <button
            ...
            className="active:bg-orange-600 my-2 w-full rounded-sm lg:px-5 md:px-4 sm:px-3 px-2 xl:px-6 py-1 lg:py-2 bg-primary lg:text-base md:text-sm sm:text-xs text-[10px] text-white font-bold md:hover:scale-105 md:hover:bg-orange-600"
          >
            Ikut Donasi
          </button>
        </div>
